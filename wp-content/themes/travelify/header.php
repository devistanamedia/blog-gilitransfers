...
<head>
<meta name="google-site-verification" content="GCBQrMekl0b6l8cfPHp2CtkpjuHVSIm4PBcvxH2vKVc" />
	
	<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-113967176-5"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-113967176-5');
</script>
